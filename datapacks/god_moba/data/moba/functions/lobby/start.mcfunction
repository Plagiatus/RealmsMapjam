...
execute if score #t1 tmp matches 0 run tellraw @p [{"text": "No players in team red. Needs players in both teams!", "color": "red"}]
execute if score #t1 tmp matches 0 run return 0
execute if score #t2 tmp matches 0 run tellraw @p [{"text": "No players in team blue. Needs players in both teams!", "color": "red"}]
