...
execute if score @s[tag=junglemonster] poseidon.sea_squall_timer matches ..0 run function utility:damage {target: "@s", amount: 3, type: "drown", attacker: "@a[scores={god=1},distance=..4,limit=1]"}
