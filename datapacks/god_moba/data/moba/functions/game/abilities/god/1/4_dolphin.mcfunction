...
execute if entity @s[team=t1] unless entity @e[limit=1,sort=random,distance=..10,team=t2] anchored eyes facing entity @e[tag=junglemonster] eyes rotated ~ ~ run function utility:shoot_facing {source: "@s", target: "@e[tag=projectile,limit=1]", force: 2}
execute if entity @s[team=t2] unless entity @e[limit=1,sort=random,distance=..10,team=t1] anchored eyes facing entity @e[tag=junglemonster] eyes rotated ~ ~ run function utility:shoot_facing {source: "@s", target: "@e[tag=projectile,limit=1]", force: 2}
