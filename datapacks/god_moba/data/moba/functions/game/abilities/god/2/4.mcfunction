execute if entity @s[team=t1] run scoreboard players set @e[type=player,team=t1] zeus.king_of_gods 600
...
execute if entity @s[team=t2] run scoreboard players set @e[type=player,team=t2] zeus.king_of_gods 600
