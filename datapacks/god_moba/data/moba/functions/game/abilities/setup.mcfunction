...
scoreboard players set #god2 cd.3 300
scoreboard players set #god2 cd.4 1800

scoreboard players set #god3 cd.1 20
scoreboard players set #god3 cd.2 200
scoreboard players set #god3 cd.3 200
scoreboard players set #god3 cd.4 1000



# add ability specific scoreboards
